"""Risk helpers for OI Expansion Failure Fade."""
...
def build_risk_plan(context: dict[str, Any], side: str | None = None) -> dict[str, Any]:
    ...
    stop_loss_pct = 0.45 if execution_quality >= 75 else 0.55 if execution_quality >= 55 else 0.65
    take_profit_pct = 0.85 if execution_quality >= 75 else 0.95 if execution_quality >= 55 else 1.10
...
def calculate_position_size(
    *,
    ...
    size_pct = 0.008 if execution_quality >= 75 else 0.006 if execution_quality >= 55 else 0.005
