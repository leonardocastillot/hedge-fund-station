"""Paper candidate and runtime helpers for BTC Guarded Cycle Trend."""
...
def paper_candidate(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "thesis": "Participate in BTC cycle uptrends with partial exposure and daily exits that protect against deep cycle breaks.",
        "trigger_plan": latest_signal.get("trigger_plan", "Enter long when close > SMA150, SMA50 > SMA150, and RSI14 > 42."),
...
def build_entry_decision(
    *,
    ...
    if signal_eval.get("signal") != "long":
        return {"shouldOpen": False, "blockReason": "no_guarded_cycle_signal", "tradePayload": None, "signalPayload": None}

    sizing = calculate_position_size(portfolio_value=portfolio_value, risk_fraction=0.10)
    ...
    thesis = "BTC Guarded Cycle Trend paper runtime entry from backend daily strategy signal."
    trigger_plan = "Enter long when BTC daily close > SMA150, SMA50 > SMA150, and RSI14 > 42."
