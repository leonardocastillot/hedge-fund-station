"""Risk and sizing helpers for BTC Vol Dynamic Trail Trend."""
...
def calculate_position_size(
    *,
    ...
    return {
        ...
        "dynamic_multiplier": float(sig.get("dynamic_multiplier") or 5.0),
...
def build_risk_plan(context: dict[str, Any] | None = None) -> dict[str, Any]:
    return {
        ...
        "atr_stop_multiplier": "dynamic_5.0_to_2.0_over_80d",
        "sizing_method": "risk_budgeting_via_atr_with_dynamic_trail",
        "max_concurrent_positions": 1,
        "invalidation_plan": "Exit on dynamic ATR trailing stop (5.0x→2.0x over 80d), trend break (close < SMA150), or time stop (200 days).",
        "context": context or {},
    }
