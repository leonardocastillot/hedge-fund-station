...
def calculate_position_size(
    *,
    ...
    if atr_stop_dist_pct <= 0:
        return {"strategy_id": STRATEGY_ID, "can_enter": False, "size_usd": 0.0, "exposure_fraction": 0.0, "block_reason": "atr_stop_distance_zero"}
    ...
    return {
        ...
        "composite_score": float(sig.get("composite_score") or 0),
...
def build_risk_plan(context: dict[str, Any] | None = None) -> dict[str, Any]:
    return {
        ...
        "atr_stop_multiplier": "vol_scaled_2.5x_to_5.5x",
        "sizing_method": "structural_conviction_with_vol_scaling",
        "max_concurrent_positions": 1,
        "invalidation_plan": "Exit on ATR trailing stop, trend structure break (close < SMA200 or SMA50 < SMA200), or time stop (200 days).",
        "context": context or {},
    }
