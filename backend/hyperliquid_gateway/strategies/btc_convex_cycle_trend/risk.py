"""Risk and sizing helpers for BTC Convex Cycle Trend."""

from __future__ import annotations

from typing import Any

from .logic import BASE_EXPOSURE_FRACTION, CONVEX_EXPOSURE_FRACTION, STRATEGY_ID, TRAILING_EXIT_DRAWDOWN_PCT

MAX_EXPOSURE_FRACTION = CONVEX_EXPOSURE_FRACTION
...
def build_risk_plan(context: dict[str, Any] | None = None) -> dict[str, Any]:
    return {
        ...
        "convex_exposure_fraction": CONVEX_EXPOSURE_FRACTION,
