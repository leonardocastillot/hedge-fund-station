"""Risk and sizing helpers for BTC Dual Momentum Trend."""
...
def calculate_position_size(
    *,
    ...
    return {
        ...
        "momentum_bonus_active": bool((sig or {}).get("momentum_bonus_active")),
...
def build_risk_plan(context: dict[str, Any] | None = None) -> dict[str, Any]:
    return {
        ...
        "paper_allowed": True,
        "live_allowed": False,
        "max_exposure_fraction": 0.28,
        "atr_stop_multiplier": 4.0,
        "sizing_method": "risk_budgeting_via_atr_with_momentum_bonus",
        "max_concurrent_positions": 1,
        "invalidation_plan": "Exit on momentum divergence (ROC20<0<ROC90), ATR trailing stop (4.0x ATR from peak), trend break (close < SMA200), or time stop (200 days).",
        "context": context or {},
    }
