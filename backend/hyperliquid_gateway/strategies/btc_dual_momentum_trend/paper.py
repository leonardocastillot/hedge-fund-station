"""Paper candidate helpers for BTC Dual Momentum Trend."""
...
def paper_candidate(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "thesis": "Capture BTC daily trends using ROC acceleration (ROC20 > ROC90) as the primary entry filter with ATR trailing stops and momentum divergence exits.",
        "trigger_plan": latest_signal.get(
            "trigger_plan",
            "Enter long when close > SMA200, SMA50 > SMA200, RSI14 > 40, ATR percentile < 85, "
        ...
        "invalidation_plan": latest_signal.get(
            "invalidation_plan",
            "Exit on momentum divergence (ROC20<0 && ROC20<ROC90), ATR trailing stop (4.0x ATR from peak), "
            "trend break (close < SMA200), or time stop (200 days).",
        ),
        "report_context": {
