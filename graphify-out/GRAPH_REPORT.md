# Graph Report - New project 9  (2026-05-10)

## Corpus Check
- 349 files · ~277,717 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4306 nodes · 6893 edges · 249 communities (199 shown, 50 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 149 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `53bb1180`
...
4. `Agent Session History` - 43 edges
...
## Communities (249 total, 50 thin omitted)
...
Cohesion: 0.05
Nodes (54): activityCardStyle, activityItemStyle, agentCardStyle, boardEyebrowStyle, boardHeaderStyle, boardStyle, boardTitleStyle, emptyStyle (+46 more)
...
Cohesion: 0.05
Nodes (33): ChartHeader(), coverageCopy(), formatUsd(), LiquidationsChart(), WINDOW_OPTIONS, LiquidationsTimeline(), useLiquidations(), buildConfirmation() (+25 more)
...
Cohesion: 0.07
Nodes (37): AgentSupervisorBoard(), CommanderConsoleV2(), MissionChatWorkbench(), MissionConsoleLauncher(), AgentProfilesProvider(), useAgentProfilesContext(), CommanderTasksProvider(), useCommanderTasksContext() (+29 more)
...
Cohesion: 0.06
Nodes (34): CommanderTasksContext, CommanderTasksContextValue, loadArray(), loadDrafts(), loadMessages(), loadRuns(), missionTinyButtonStyle, TerminalPane (+26 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (43): 2026-05-05 - File Harness Bootstrap, 2026-05-05 - OI Expansion Failure Fade Strategy, 2026-05-06 - Backtest Evidence Gateway Contract, 2026-05-06 - BTC Doubling Stability Audit, 2026-05-06 - BTC Failed Impulse Paper Baseline, 2026-05-06 - BTC Failed Impulse Paper Collection Start, 2026-05-06 - BTC Failed Impulse Paper Runtime Loop, 2026-05-06 - BTC Failed Impulse Paper Runtime Tick (+35 more)
...
Cohesion: 0.14
Nodes (30): as_list(), build_parser(), collect_issues(), command_brief(), command_check(), command_init(), command_status(), git_dirty() (+22 more)
...
Cohesion: 0.11
Nodes (24): list_csv_files(), add_agent_ai_args(), build_paper_runtime_tick_url(), build_parser(), command_agent_audit(), command_doctor(), command_paper_runtime_loop(), command_paper_runtime_tick() (+16 more)
...
Cohesion: 0.14
Nodes (18): AIConfigManager, AIConfigStatus, AISaveGeminiApiKeyParams, getConfigPath(), HedgeFundAIConfig, readAIConfig(), resolveGeminiApiKey(), resolveGeminiLiveModel() (+10 more)
...
Cohesion: 0.11
Nodes (17): BackendProbe, BackendProbeResult, BackendStatus(), ContractState, initialResults, labelFor(), probes, readinessTone() (+9 more)
...
Cohesion: 0.22
Nodes (12): readLocalEnvValue(), extensionFromMimeType(), fetchGeminiJsonWithTimeout(), GeminiGenerateContentResponse, getGeminiApiKey(), getOpenAIApiKey(), loadLocalEnv(), normalizeMimeType() (+4 more)
...
Cohesion: 0.2
Nodes (5): Paper candidate helpers for BTC Failed Impulse Balanced Fast., Ranking helpers for BTC Failed Impulse Balanced Fast., calculate_execution_quality(), Ranking helpers for BTC Failed Impulse Reversal., score_setup()
...
## Knowledge Gaps
- **1563 isolated node(s):** `Backend package for hedge-fund-station.`, `Hyperliquid gateway backend package.`, `Log a system metric to the database for monitoring and analysis.      Args:`, `Get system health metrics including circuit breaker status and recent metrics.`, `Centralized logging system for Polymarket trading bot.  Provides structured logg` (+1558 more)
...
- **Why does `normalize()` connect `Community 35` to `Community 153`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `orderbook()` connect `Community 153` to `Community 18`, `Community 35`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `HyperliquidService` connect `Community 16` to `Community 2`, `Community 5`, `Community 10`, `Community 19`, `Community 20`, `Community 22`, `Community 25`, `Community 39`, `Community 45`, `Community 53`, `Community 58`, `Community 60`, `Community 64`, `Community 68`, `Community 78`, `Community 85`, `Community 99`, `Community 101`, `Community 107`?**
