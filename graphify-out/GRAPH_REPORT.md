...
## Communities (247 total, 53 thin omitted)
...
Cohesion: 0.03
Nodes (69): artifactPreStyle, blueprintLabelStyle, blueprintListStyle, composerCardStyle, containerStyle, deliverableChipStyle, deliverablesStripStyle, depthChipStyle (+61 more)
...
Cohesion: 0.04
Nodes (46): actionsStyle, copyStyle, emptyStyle, eyebrowStyle, fieldStyle, formGridStyle, headerStyle, inputStyle (+38 more)
...
Cohesion: 0.07
Nodes (9): backtestRunPayload(), ensureBacktestQuery(), HyperliquidService, invalidatePaperCaches(), normalizeBacktestRunOptions(), normalizeRequestError(), LiquidationsService, invalidateRequestCache() (+1 more)
...
Cohesion: 0.1
Nodes (38): discover_strategy_packages(), get_strategy_definition(), resolve_default_dataset(), run_registered_backtest(), StrategyDefinition, ValidationPolicy, build_artifact_id(), build_btc_variant_optimizer_workflow() (+30 more)
...
Cohesion: 0.09
Nodes (29): AgentSupervisorBoard(), CommanderConsoleV2(), MissionChatWorkbench(), MissionConsoleLauncher(), useAgentProfilesContext(), CommanderTasksContext, CommanderTasksContextValue, loadArray() (+21 more)
...
Cohesion: 0.06
Nodes (25): WidgetPanel(), AgentProfilesProvider(), CommanderTasksProvider(), ContextConfig, ContextContext, ContextContextValue, ContextProvider(), CONTEXTS (+17 more)
...
Cohesion: 0.08
Nodes (22): activityCardStyle, activityItemStyle, agentCardStyle, boardEyebrowStyle, boardHeaderStyle, boardStyle, boardTitleStyle, emptyStyle (+14 more)
...
Cohesion: 0.14
Nodes (16): AIConfigManager, AIConfigStatus, AISaveGeminiApiKeyParams, getConfigPath(), HedgeFundAIConfig, readAIConfig(), resolveGeminiLiveModel(), safeJsonParse() (+8 more)
...
Cohesion: 0.14
Nodes (14): LocalCheckRow(), LocalPreflightCheck, ReadinessCheckRow(), statusTone(), HyperliquidReadinessCheck, clearTelemetryEvents(), events, getTelemetryEvents() (+6 more)
...
## Knowledge Gaps
- **1564 isolated node(s):** `Backend package for hedge-fund-station.`, `Hyperliquid gateway backend package.`, `Log a system metric to the database for monitoring and analysis.      Args:`, `Get system health metrics including circuit breaker status and recent metrics.`, `Centralized logging system for Polymarket trading bot.  Provides structured logg` (+1559 more)
...
- **Why does `normalize()` connect `Community 35` to `Community 146`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `orderbook()` connect `Community 146` to `Community 35`, `Community 15`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `HyperliquidService` connect `Community 12` to `Community 64`, `Community 2`, `Community 67`, `Community 3`, `Community 4`, `Community 102`, `Community 71`, `Community 11`, `Community 48`, `Community 17`, `Community 82`, `Community 16`, `Community 80`, `Community 30`, `Community 22`, `Community 87`, `Community 57`, `Community 94`?**
