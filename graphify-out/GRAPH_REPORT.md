...
## Corpus Check
- 349 files · ~277,847 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4205 nodes · 6743 edges · 241 communities (192 shown, 49 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 149 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8db71364`
...
3. `Agent Session History` - 44 edges
...
Cohesion: 0.05
Nodes (43): ChartHeader(), coverageCopy(), formatUsd(), LiquidationsChart(), WINDOW_OPTIONS, LiquidationsTimeline(), LiquidationsContext, LiquidationsContextType (+35 more)
...
Cohesion: 0.04
Nodes (45): WidgetPanel(), CollapsedRailProps, collapsedRailStyle, ElectronLayout(), handleButtonStyle, MissionChatWorkbench, railActionIconStyle, railButtonStyle (+37 more)
...
Cohesion: 0.07
Nodes (37): AgentSupervisorBoard(), CommanderConsoleV2(), MissionChatWorkbench(), MissionConsoleLauncher(), useAgentProfilesContext(), CommanderTasksProvider(), useCommanderTasksContext(), ContextConfig (+29 more)
...
Cohesion: 0.09
Nodes (40): apply_pipeline_gate(), build_paper_runtime_supervisor_status(), _clean_gate_reasons(), file_modified_at_ms(), first_present_graphify_value(), graphify_built_commit(), graphify_changed_paths_since_built(), graphify_collection() (+32 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (14): CaptureFormState, formatGraphCommit(), formatGraphCount(), formatGraphUpdatedAt(), formatGraphWorktree(), graphFreshnessSummary(), GraphifyOpenPathMessage, learningOutcomeLabel() (+6 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (44): 2026-05-05 - File Harness Bootstrap, 2026-05-05 - OI Expansion Failure Fade Strategy, 2026-05-06 - Backtest Evidence Gateway Contract, 2026-05-06 - BTC Doubling Stability Audit, 2026-05-06 - BTC Failed Impulse Paper Baseline, 2026-05-06 - BTC Failed Impulse Paper Collection Start, 2026-05-06 - BTC Failed Impulse Paper Runtime Loop, 2026-05-06 - BTC Failed Impulse Paper Runtime Tick (+36 more)

### Community 22 - "Community 22"
Cohesion: 0.08
Nodes (34): activityCardStyle, activityItemStyle, agentCardStyle, boardEyebrowStyle, boardHeaderStyle, boardStyle, boardTitleStyle, emptyStyle (+26 more)
...
Cohesion: 0.1
Nodes (37): available_strategies(), latest_json(), add_source(), add_timeline(), agent_run_response(), agent_runs(), artifact_generated_ms(), artifact_strategy_id() (+29 more)
...
Cohesion: 0.11
Nodes (24): AIConfigManager, AIConfigStatus, AISaveGeminiApiKeyParams, getConfigPath(), HedgeFundAIConfig, readAIConfig(), readLocalEnvValue(), resolveGeminiApiKey() (+16 more)
...
Cohesion: 0.08
Nodes (20): LayoutUpdateCallback, TerminalColor, TerminalContext, TerminalContextValue, TerminalProvider(), TerminalPtyState, TerminalSession, COLOR_SCHEMES (+12 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (28): CommanderTasksContext, CommanderTasksContextValue, loadArray(), loadDrafts(), loadMessages(), loadRuns(), ApprovedMission, MissionActionRecord (+20 more)
...
Cohesion: 0.1
Nodes (9): finalize_strategy_row(), make_strategy_row(), status_from_artifacts(), strategies_catalog(), strategy_catalog_card(), strategy_catalog_payload(), strategy_document_sort_key(), btc_runtime_history() (+1 more)

### Community 47 - "Community 47"
Cohesion: 0.1
Nodes (18): DiagnosticsPage(), LocalCheckRow(), LocalPreflightCheck, ReadinessCheckRow(), statusTone(), HyperliquidReadinessCheck, clearTelemetryEvents(), events (+10 more)
...
Cohesion: 0.09
Nodes (27): append_alert(), close_paper_trade(), create_paper_signal(), create_paper_trade(), current_price_map(), db_connection(), paper_session_analytics(), paper_signal_payloads() (+19 more)
...
Cohesion: 0.1
Nodes (16): LiquidationsProvider(), useMarketPolling(), DepthBar(), firstCheck(), formatCompact(), formatPct(), HyperliquidIntelligencePage(), MarketFilter (+8 more)
...
Cohesion: 0.11
Nodes (15): formatCurrency(), PortfolioDashboardPage(), HyperliquidPaperTrade, HyperliquidStrategyNextAction, backendDecisionLabel(), backendDirection(), DeployedStrategy, mapBackendStrategy() (+7 more)
...
Cohesion: 0.19
Nodes (18): list_csv_files(), build_artifact_id(), build_btc_variant_optimizer_workflow(), build_doubling_stability_workflow(), build_paper_workflow(), build_production_candidate_assessment(), build_research_snapshot(), now_iso() (+10 more)
...
Cohesion: 0.25
Nodes (14): discover_strategy_packages(), build_status_snapshot(), discover_artifact_strategy_ids(), discover_strategy_document_paths(), discover_strategy_documents(), infer_strategy_stage(), is_strategy_document_path(), latest_matching_validation() (+6 more)
...
## Knowledge Gaps
- **1517 isolated node(s):** `Backend package for hedge-fund-station.`, `Hyperliquid gateway backend package.`, `Log a system metric to the database for monitoring and analysis.      Args:`, `Get system health metrics including circuit breaker status and recent metrics.`, `Centralized logging system for Polymarket trading bot.  Provides structured logg` (+1512 more)
...
- **Why does `normalize()` connect `Community 36` to `Community 145`?**
  _High betweenness centrality (0.205) - this node is a cross-community bridge._
- **Why does `orderbook()` connect `Community 145` to `Community 18`, `Community 36`?**
  _High betweenness centrality (0.205) - this node is a cross-community bridge._
- **Why does `HyperliquidService` connect `Community 13` to `Community 66`, `Community 2`, `Community 100`, `Community 69`, `Community 99`, `Community 4`, `Community 103`, `Community 9`, `Community 45`, `Community 15`, `Community 80`, `Community 17`, `Community 47`, `Community 20`, `Community 53`, `Community 56`, `Community 26`, `Community 91`?**
